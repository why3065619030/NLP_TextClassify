...
df = pd.DataFrame(list(zip(pred_texts,preds,labels,scores,  negative, neutral, positive,res_time)), columns=['text','pred','label','score', 'negative', 'neutral', 'positive','time'])
df.head()
